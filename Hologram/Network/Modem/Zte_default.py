...
DEFAULT_ZTE_TIMEOUT = 200

class Zte_default(Modem):

    usb_ids = [('19d2', '0003'),('19d2','0026'),('19d2','0053'),('19d2','0103'),('19d2','0115'),('19d2','2000'),('19d2','fff5'),('19d2','fff6')]
    ...
    def connect(self, timeout = DEFAULT_ZTE_TIMEOUT):
